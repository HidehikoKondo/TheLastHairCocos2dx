package jp.udonkonet.the_last_hair;

import jp.udonkonet.the_last_hair.R;
...
public class NativeCodeAst {
    ...
    {
        final the_last_hair activity = the_last_hair.getActivity();
     ...
     */
    private static void initAstJni_main(the_last_hair activity)
    {
